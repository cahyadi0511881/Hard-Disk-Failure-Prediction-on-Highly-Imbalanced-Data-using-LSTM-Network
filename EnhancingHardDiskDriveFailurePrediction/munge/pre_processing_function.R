# Normal function without undersampling

prediction_days_processing_normal = function(dataframe,observation_days,prediction_days){
  ...
  processed_data_normal = rbind(failed_data_processed, non_failed_processed)
  
  
  return(processed_data_normal)
  
}

cache('prediction_days_processing_normal')
